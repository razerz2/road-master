                                    ...
                                    <tr class="table-row-hover">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                @endcan
                                                @can('delete', $vehicle)
                                                <form action="{{ route('vehicles.destroy', $vehicle) }}" method="POST" class="inline" onsubmit="event.preventDefault(); if (typeof handleDelete === 'function') { handleDelete(this, 'Tem certeza que deseja excluir este veículo?'); } else { if (confirm('Tem certeza que deseja excluir este veículo?')) { this.submit(); } }">
                                                    @csrf
                                                    @method('DELETE')
