                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="type" name="type" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm" required>
                                    ...
                                    <option value="posto_combustivel" {{ old('type') == 'posto_combustivel' ? 'selected' : '' }}>Posto de Combustível</option>
                            ...
                            <div>
                                ...
                                <select id="location_type_id" name="location_type_id" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm">
                                    ...
                                    @foreach($locationTypes as $locationType)
                                        <option value="{{ $locationType->id }}" {{ old('location_type_id') == $locationType->id ? 'selected' : '' }}>
                                            {{ $locationType->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="address" name="address" rows="2" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600">{{ old('address') }}</textarea>
                            ...
                            <div>
                                ...
                                <x-text-input id="zip_code" class="block mt-1 w-full" type="text" name="zip_code" :value="old('zip_code')" maxlength="10" placeholder="00000-000" />
                            ...
                            <div>
                                ...
                                <x-text-input id="state" class="block mt-1 w-full" type="text" name="state" :value="old('state')" maxlength="2" placeholder="SP" />
