                    ...
                    <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data" id="userForm">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-2 space-y-4">
                                ...
                                <div class="flex items-center space-x-6">
                                    <div class="relative">
                                        <img id="avatarPreview" src="" alt="Preview" class="w-32 h-32 rounded-full object-cover border-4 border-gray-300 dark:border-gray-600 hidden">
                                        <div id="avatarPlaceholder" class="w-32 h-32 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center border-4 border-gray-300 dark:border-gray-600">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name_full" class="block mt-1 w-full" type="text" name="name_full" :value="old('name_full')" />
                        ...
                        <!-- Módulos de Acesso -->
                        <div class="mt-8" id="modules-section" style="display: none;">
