    ...
    <div class="w-full flex justify-between items-center h-16 pr-4 sm:pr-6 lg:pr-8">
            ...
            <div class="hidden sm:flex sm:items-center gap-3">
                ...
                <div x-data="{ 
                    ...
                    loadNotifications() {
                        @auth
                        fetch('{{ route('notifications.api.latest') }}')
                        ...
                        <x-slot name="content">
                            ...
                            <div class="max-h-96 overflow-y-auto">
                                ...
                                <template x-for="notification in notifications" :key="notification.id">
                                    <a :href="notification.link || '{{ route('notifications.index') }}/' + notification.id" class="block px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 border-b border-gray-100 dark:border-gray-700 last:border-b-0">
