@php
    ...
    $isEdit = isset($paymentMethod) && $paymentMethod !== null;
@endphp
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
        ...
        <x-text-input 
            ...
            type="text" 
            name="name"
            :value="old('name', $isEdit ? $paymentMethod->name : '')"
            required 
        />
    ...
    <div>
        ...
        <x-text-input 
            ...
            type="number" 
            name="order"
            :value="old('order', $isEdit ? $paymentMethod->order : 0)"
            min="0"
        />
    ...
    <div class="md:col-span-2">
        ...
        <textarea 
            ...
            rows="3"
            name="description"
        >{{ old('description', $isEdit ? ($paymentMethod->description ?? '') : '') }}</textarea>
    ...
    <div>
        <label class="flex items-center">
            <input 
                ...
                name="active"
                value="1"
                {{ old('active', $isEdit ? ($paymentMethod->active ?? true) : true) ? 'checked' : '' }}
