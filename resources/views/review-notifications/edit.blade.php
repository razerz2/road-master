                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('review-notifications.update', $reviewNotification) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                <label class="flex items-center">
                                    <input type="checkbox" name="recurring" value="1" {{ old('recurring', $reviewNotification->recurring) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" id="recurring-checkbox">
                            ...
                            <div class="md:col-span-2" id="recurrence-interval-field" style="display: {{ old('recurring', $reviewNotification->recurring) ? 'block' : 'none' }};">
                                <x-input-label for="recurrence_interval_km" :value="__('Intervalo de Recorrência (KM)')" />
                                <x-text-input id="recurrence_interval_km" class="block mt-1 w-full" type="number" name="recurrence_interval_km" :value="old('recurrence_interval_km', $reviewNotification->recurrence_interval_km)" min="1" />
